...
private ArrayList<Direccion> direccionesJPA;
    ...
    public ArrayList<Direccion> getDireccionesJPA() {
    return direccionesJPA;
}

public void setDireccionesJPA(ArrayList<Direccion> direccionesJPA) {
